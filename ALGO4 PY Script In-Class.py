...
s = requests.Session()
s.headers.update({'X-API-key': 'BJBVZKPC'}) # Make sure you use YOUR API Key

"""
This week we use assets in the RIT
The charge you fee for creating the ETF, if you redeem the stock
The fee is a disincentive to redeem, if you don;t redeem, it compensate potential losses
What happens when I click on use assets"""
...
def main():
    ...
    while status == 'ACTIVE':        
        ...
        for i in range(3):
            ...
            # What if there's a growing trend
            # How long does it take you to accumulate position. What's the max number you can trade at ...
            # Actively traded, this is not the only way you can enter the trade, maybe you can use passive orders, for example, bid for the stock and offer etf.
            # speed, volumn
